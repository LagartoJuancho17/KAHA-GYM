        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-205 rounded-xl p-2.5 text-slate-900 font-semibold focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 box-border"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full bg-white border border-slate-205 rounded-xl p-3 text-slate-800 font-medium focus:outline-none focus:ring-1 focus:ring-emerald-500 focus:border-emerald-500 leading-relaxed font-sans resize-none box-border"
            />
          </div>
