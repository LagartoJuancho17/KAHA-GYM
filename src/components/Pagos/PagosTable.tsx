                ...
                pagosFiltrados.map(p => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-zinc-50/50">
                      ...
                      <td className="p-4"><span className="px-2 py-0.5 rounded bg-zinc-100 border border-zinc-200 text-[10px] uppercase font-bold text-zinc-705">{p.medio_pago}</span></td>
                      <td className="p-4 font-mono font-bold text-zinc-650">{p.mes_correspondiente}</td>
                      <td className="p-4">
